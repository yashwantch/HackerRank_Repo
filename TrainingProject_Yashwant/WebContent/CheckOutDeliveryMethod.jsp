		...
		<div class="col-md-5">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-end" style="background: none;">
					...
					<li class="breadcrumb-item"><a href="#">CHECKOUT-DELIVERY
							METHOD</a></li>
				</ol>
			</nav>
		</div>
				...
				<ul class="nav nav-pills nav-fill"
					...
					<li class="nav-item"><a class="nav-link" href="#"
						style="color: #ffffff; background-color: #20B2AA;"><i
							class="fas fa-truck"></i><br>Delivery Method</a></li>
					<li class="nav-item"><a class="nav-link" href="#"
					...
					<div class="col-md-6">
						<div class="card"
							...
							<div class="card-body">
								...
								<p class="card-text">Get it right on next day-fastest option
									possible</p>
								<br>
							</div>
					...
					<div class="row">
						<div class="card-body">
							...
							<div class="col-md-6 justify-content-end">
								<a href="CheckOutPaymentMethod.jsp"><button
										class="button1 text-righ"
										style="background-color: #20B2AA; color: #ffffff;">
										CONTINUE TO PAYMENT METHOD &nbsp;<span
