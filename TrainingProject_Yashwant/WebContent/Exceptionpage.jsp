...
<%@ include file="index12.html" %>
	...
	<div class="container">
			...
			<br>
			<hr>
			<h2><b>Sorry for the Inconvenience- The Page you are looking for have technical errors </b></h2>
			<h4>Kindly proceed to the Home Page or Report this issue to Website Administrator with the Description mentioned below:</h4>
			<br>
